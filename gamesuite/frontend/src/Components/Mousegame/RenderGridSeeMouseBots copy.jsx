...
export default function RenderGridSeeBots(props){
    ...
    const bot4plan = processFromFlatIndexBot4(props.data.bot4.plans,turn-6)
    ...
    return(<div className="relative w-full h-full">
        {botsInSpace.map((bot,i)=>(
            <div
                ...
                >
            {(bot.id<6&&bot.id>0)&& bot.id}</div>))}{(mouse_index[0]===props.i&&mouse_index[1]===props.j)&&<div className={"open-sq mouse-sprite "+ props.directionFrames}></div>}
    </div>)
